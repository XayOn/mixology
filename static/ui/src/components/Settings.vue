<template>
  <v-container>
    ...
    <v-row>
      <v-col cols="4" v-bind:key="title" v-for="(tasmota, title) in settings.tasmotas">
    ...
    <v-row>
      <v-col>
        <v-btn block color="primary" @click="save()" elevation="7" large>Save settings</v-btn>
      </v-col>
      <v-col>
        <v-btn block color="secondary" @click="updateTasmotas()" elevation="7" large>Find new tasmotas</v-btn>
      </v-col>
    </v-row>
  </v-container>
</template>
